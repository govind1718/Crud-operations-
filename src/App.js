...
function App() {
 ...
 const deleteUser = async (id) => {
   ...
   useEffect(()=>{
    ...
    callGetAPI();
   },[edit,firstName,lastName,mobileNumber,email,dob,address,accountNumber,ifscCode,bankName]);
  ...
  return (   
      ...
      <div>
        <h5  className="p1">{data.firstName}</h5>
      </div>
      
      <div>
        <h5 className="p11">{data.lastName}</h5>
      </div>
